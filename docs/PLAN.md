...
| 5 | B1 | bump to `rapier2d = "=0.1.0-alpha.2"` (BT1 + BT2 + accessors + CW; WorldState v2), new activation reads in the rules, every golden / fixture / executable regenerated, before / after steps table | Sonnet | G8b, alpha.2 |
