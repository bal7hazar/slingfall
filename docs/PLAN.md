...
| 4 | G8b | retune + pre-settle `pile10` / `cores3`, regenerate every dependent golden / fixture, CI `golden` matrix for the 3 new levels, client level list | Sonnet | G8 |
