...
| 5 | H1 | housekeeping: `ball_drop` stand-in on alpha.2, validator `LEGACY` list, `golden` legs under 8 min, `browser-check.py` runnable | Sonnet | B1 |
...
| B1 | #17 | alpha.2: no code change, **all 11 goldens bit-identical**, steps −27 % to −52 %: pile10 reference **10.7M**, tower 27.6M, bridge 11.2M, cores3 13.5M, twin 2 x 13.4M, 3-shot levels 18M; flight tick 56.6k -> 16.9k, impact tick 1.02M -> 652k. Accessors not adopted in `calm.cairo` (measured worse until rapier BT4). Follow-ups: stand-in on alpha.1 (H1) |
