...
| 3 | G3b | rules follow-up: pebble damping (D5), un-ignore the whole-shot tests under the raised step cap, `level.projectiles` read (kind 0 only), static-load note for G8 | Sonnet | G3 |
